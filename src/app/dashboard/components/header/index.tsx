        ...
        <>
            ...
            <CSidebar className="sidebar-dark border-end" visible={visible}>
                ...
                <CSidebarNav>
                    ...
                    <CNavItem href="#">
                        Fundição <span className="badge bg-primary ms-auto">10</span>
                        <i className="nav-icon cil-speedometer"></i>
                    </CNavItem>
                    <CNavItem href="#">
                        IMF <span className="badge bg-primary ms-auto">10</span>
                        <i className="nav-icon cil-speedometer"></i>
                    </CNavItem>
                    <CNavItem href="#">
                        USINAGEM <span className="badge bg-primary ms-auto">10</span>
                        <i className="nav-icon cil-speedometer"></i>
                    </CNavItem>
                    ...
                    <CNavItem href="https://coreui.io">Configuracao</CNavItem>
